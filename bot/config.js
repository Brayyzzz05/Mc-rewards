export default {
    reward: {
      pool: [
        ...
        // ── S-TIER — Weapons ────────────────────────────────────────────
        { tier: "s", cmd: "give {player} netherite_sword[enchantments={sharpness:5,looting:3,fire_aspect:2,unbreaking:3,mending:1}] 1",                                       chance: 20 },
        { tier: "s", cmd: "give {player} netherite_axe[enchantments={sharpness:5,efficiency:5,unbreaking:3,mending:1}] 1",                                                    chance: 18 },
        { tier: "s", cmd: "give {player} bow[enchantments={power:5,flame:1,infinity:1,unbreaking:3}] 1",                                                                      chance: 15 },
        { tier: "s", cmd: "give {player} crossbow[enchantments={quick_charge:3,multishot:1,unbreaking:3}] 1",                                                                 chance: 12 },
        { tier: "s", cmd: "give {player} trident[enchantments={riptide:3,unbreaking:3,mending:1}] 1",                                                                         chance: 10 },
        { tier: "s", cmd: "give {player} trident[enchantments={loyalty:3,channeling:1,impaling:5,unbreaking:3,mending:1}] 1",                                                 chance: 10 },
        { tier: "s", cmd: "give {player} mace[enchantments={wind_burst:1,density:5,unbreaking:3,mending:1}] 1",                                                               chance: 8 },
        ...
        // ── S-TIER — Beacon Kit ─────────────────────────────────────────
        { tier: "s", cmd: "give {player} beacon 1 && give {player} iron_block 164 && give {player} netherite_ingot 1 && give {player} glass 16 && give {player} obsidian 4 && give {player} iron_pickaxe[enchantments={efficiency:5,unbreaking:3}] 1", chance: 2 },

        // ── S-TIER — 🎰 JACKPOT: Endgame Shulker Kit ───────────────────
        { tier: "s", cmd: "give {player} elytra[enchantments={unbreaking:3}] 1 && give {player} totem_of_undying 2 && give {player} golden_apple 32 && give {player} firework_rocket[fireworks={flight:3}] 64 && give {player} netherite_sword[enchantments={sharpness:5,looting:3,fire_aspect:2,unbreaking:3,mending:1}] 1 && give {player} netherite_pickaxe[enchantments={efficiency:5,fortune:3,unbreaking:3,mending:1}] 1 && give {player} enchanted_book[stored_enchantments={mending:1}] 1 && give {player} experience_bottle 32 && give {player} ender_pearl 16", chance: 1 }
      ]
    },
